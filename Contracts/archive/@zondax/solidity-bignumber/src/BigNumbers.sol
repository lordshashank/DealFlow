...
library BigNumbers {
    ...
    function _add(
        ...
        assembly {
            ...
            let result_start := mload(0x0)                                      // Get the highest available block of memory
            let carry := 0
    ...
    function _sub(
        ...
        assembly {
            ...
            let result_start := mload(0x0)                                     // Get the highest available block of 
                                                                            // memory
